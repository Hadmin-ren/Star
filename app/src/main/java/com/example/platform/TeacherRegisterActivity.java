...
public class TeacherRegisterActivity extends AppCompatActivity implements View.OnClickListener, View.OnFocusChangeListener, TextWatcher {
...
//        sendCode(getApplicationContext());
    ...
    private void register(){
        ...
        if (flag == 0){
            ...
            Intent intent = new Intent(TeacherRegisterActivity.this, Main2Activity.class);
