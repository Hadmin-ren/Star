...
import com.example.platform.bean.JsonQuestBean;
import com.example.platform.bean.QuestBean;
import com.example.platform.constants.Config;
import com.example.platform.db.LoveDao;
import com.example.platform.fragment.AnswerFragment;
import com.example.platform.utils.LogUtils;
import com.example.platform.utils.ToastUtils;
...
//      联网获取数据
    ...
    private void initNet() {
        ...
        com.example.platform.utils.LogUtils.e("initNet: 开始联网…………");
        //进度条对话框
...
//                            LoveDao.insertLove(questBeanQ);
                            ...
                            com.example.platform.utils.LogUtils.e(i + "   onSuccess    : " + questBeanQ.getId() + questBeanQ.getTitle());
                        }
//                        设置适配器
                    ...
                    public void onError(Call call, Response response, Exception e) {
                        com.example.platform.utils.LogUtils.e("onError  ");
                    }
                });
        com.example.platform.utils.LogUtils.e("initNet: 联网结束…………");
    }
...
//                        判断
                ...
                com.example.platform.utils.LogUtils.e("经过计算后，该试卷得分为" + grade);
